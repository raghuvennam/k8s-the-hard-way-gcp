...
In this section you will provision an external load balancer to front the Kubernetes API Servers. The `k8s-the-hard-way` static IP address will be attached to the resulting load balancer.
